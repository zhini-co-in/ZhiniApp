...
//
// Backend: GET {baseUrl}/getCustomerBilling?phone=<10-digit-mobile>
// (see ApiConfig.customerBillingUrl — add this getter, snippet below).
//
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ---- Total — tap to open the full bill/invoice popup ----
          if (hasBill) ...[
            const SizedBox(height: 12),
